var CanvasParticle = (function(){
	...
	function canvasInit(canvasConfig){
		...
		// 获取特定div作为背景
		// effects是你想要将其作为背景的div的ID
		var body = document.getElementById("effects");
	...
	function canvasSize(canvas){
		...
		// 获取特定div的宽高
		// var width = document.getElementById("effects").style.width;
		// var height = document.getElementById("effects").style.height;
